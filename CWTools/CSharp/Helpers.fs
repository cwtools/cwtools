...
type Helpers =
    static member LoadAndInitializeFromConfigFiles (configs : (string * string) seq) (game : Game) (useFormulas : bool) =
        ...
        let rules, types, enums, complexenums, values =
            configs
                ...
                |> CWTools.Rules.RulesParser.parseConfigs (scopeManager.ParseScope()) (scopeManager.AllScopes) (scopeManager.AnyScope) (scopeManager.ScopeGroups) useFormulas
