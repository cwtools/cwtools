...
type VIC3Game(setupSettings : VIC3Settings) =
    let validationSettings = {
        ...
        experimental = false
        fileValidators = []
        lookupValidators = [valUniqueTypes, "uniques"; validateUndefinedModifierTypes, "undefinedmodifiers"]
    ...
    let changeScope = Scopes.createJominiChangeScope CWTools.Process.Scopes.VIC3.oneToOneScopes (Scopes.complexVarPrefixFun "variable:from:" "variable:")
