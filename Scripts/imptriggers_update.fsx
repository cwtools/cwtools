...
let triggers =
    JominiParser.parseTriggerFilesRes @"C:\Users\Thomas\git\cwtools-ir-config/triggers.log"

let effects =
    JominiParser.parseEffectFilesRes @"C:\Users\Thomas\git\cwtools-ir-config/effects.log"
