...
let embeddedTests =
    testList "embedded" [
        ...
        let resources : IResourceAPI<STLComputedData> = ResourceManager<STLComputedData>(STLCompute.computeSTLData (fun () -> None), STLCompute.computeSTLDataUpdate (fun () -> None)).Api
